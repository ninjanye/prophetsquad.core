...
namespace ProphetSquad.Core.Tests
{
    public class OddsConverterTests
    {
        ...
        [Theory]
        [InlineData(1.03, "1/33")]
        [InlineData(1.04, "1/25")]
        [InlineData(1.06, "1/16")]
        [InlineData(1.07, "1/14")]
        [InlineData(1.08, "1/12")]
        [InlineData(1.09, "1/11")]
        [InlineData(1.11, "1/9")]
        [InlineData(1.12, "1/8")]
        [InlineData(1.14, "1/7")]
        [InlineData(1.16, "1/6")]
        ...
        [InlineData(1.29, "2/7")]
        [InlineData(1.33, "1/3")]
        [InlineData(1.36, "4/11")]
        [InlineData(1.44, "4/9")]
        [InlineData(1.53, "8/15")]
        [InlineData(1.57, "4/7")]
        [InlineData(1.62, "8/13")]
        [InlineData(1.67, "4/6")]
        [InlineData(1.73, "8/11")]
        [InlineData(1.83, "5/6")]
        [InlineData(1.91, "10/11")]
        [InlineData(2.38, "11/8")]
        [InlineData(2.5, "6/4")]
        [InlineData(2.63, "13/8")]
        [InlineData(2.86, "15/8")]
        [InlineData(4.33, "10/3")]
        ...
        [Theory]
        [InlineData(1.71, "7/10")]
        [InlineData(1.39, "2/5")]
        [InlineData(1.82, "5/6")]
        [InlineData(1.97, "1/1")]
        [InlineData(1.63, "8/13")]
        [InlineData(3.95, "3/1")]
        [InlineData(3.96, "3/1")]
        [InlineData(1.76, "3/4")]
